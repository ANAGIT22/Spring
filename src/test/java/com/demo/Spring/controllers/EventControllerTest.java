...
public class EventControllerTest {
    ...
    void testGetAllEvents(ArrayList<Event> eventList) throws Exception {
        ...
        mockMvc.perform(request)
                ...
                .andExpect(content().json(String.format("{\"events\":%s}", MapperUtils.mapToJson(eventList))));
    }
    ...
    void testPostEventsOk(String body) throws Exception {
        Event inputEvent = MapperUtils.mapToEvent(body);
        Event expectedEvent = MapperUtils.mapToEvent(body);
